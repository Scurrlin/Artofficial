export const IMAGE_MODELS = [
  ...
  },
  {
    id: 'gpt-image-1.5',
    label: 'Gpt Image 1.5',
    bestFor: 'Production ready visuals with granular editing',
    strengths: ['High fidelity photorealism', 'Reliable text rendering and infographics', 'Multi-image compositing'],
    promptTip: 'Choose what to change and what to keep between drafts to prevent iterative drift',
  ...
  },
  {
    id: 'nano-banana-2',
    label: 'Nano Banana 2',
    bestFor: 'Cognitive generation with real time web knowledge',
    strengths: ['Deep prompt reasoning', 'Search powered visual context', 'Multilingual text support'],
    promptTip: 'Utilize creative director controls for specific lighting, camera, and lens settings',
  ...
  },
  {
    id: 'flux-2',
    label: 'FLUX.2 Pro',
    bestFor: 'Expert design work with exact color and typography control',
    strengths: ['Precise color and gradient recognition', 'Clean typography and marketing layouts', 'JSON structured prompts'],
    promptTip: 'Use hex codes for colors, quotes for text, and JSON for complex scenes',
