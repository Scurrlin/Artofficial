      ...
      <form className="mt-10" onSubmit={handleSubmit}>
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:-mt-5">
            <div className={`relative aspect-square w-full xs:max-w-md short:max-w-sm rounded-xl border border-[#10131f]/30 flex justify-center items-center overflow-hidden ${form.photo || generatingImg ? 'bg-[#10131f]' : ''}`}>
              {form.photo ? (
                <img
                  src={form.photo}
                  alt={form.prompt}
